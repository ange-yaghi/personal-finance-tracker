...
void pft::PaycheckForm::Initialize() {
    ...
    m_employerAccount.SetFieldName(std::string("EMPLOYER"));
    m_employerAccount.SetInputType(FieldInput::INPUT_LOOKUP);

	m_intermediateAccount.SetFieldName(std::string("INTERMEDIATE"));
    ...
    RegisterField(&m_employerAccount);
    RegisterField(&m_dateField);
}

void pft::PaycheckForm::Copy(Form *target) {
    // UNIMPLEMENTED
}

void pft::PaycheckForm::PopulateTransactions(Transaction *container, Transaction *basePay, Transaction *cit, Transaction *cpp, Transaction *ei,
    ...
    container->SetIntAttribute(std::string("SOURCE_ACCOUNT_ID"), m_employerAccount.GetCurrentSuggestion()->Id);
    ...
    container->SetIntAttribute(std::string("TARGET_ACCOUNT_ID"), m_destinationAccount.GetCurrentSuggestion()->Id);
    ...
    basePay->SetIntAttribute(std::string("SOURCE_ACCOUNT_ID"), m_employerAccount.GetCurrentSuggestion()->Id);
    ...
    basePay->SetIntAttribute(std::string("TARGET_ACCOUNT_ID"), m_intermediateAccount.GetCurrentSuggestion()->Id);
    ...
    cit->SetIntAttribute(std::string("TARGET_ACCOUNT_ID"), m_taxCounterparty.GetCurrentSuggestion()->Id);
    ...
    cit->SetIntAttribute(std::string("SOURCE_ACCOUNT_ID"), m_intermediateAccount.GetCurrentSuggestion()->Id);
    ...
    cpp->SetIntAttribute(std::string("TARGET_ACCOUNT_ID"), m_taxCounterparty.GetCurrentSuggestion()->Id);
    ...
    cpp->SetIntAttribute(std::string("SOURCE_ACCOUNT_ID"), m_intermediateAccount.GetCurrentSuggestion()->Id);
    ...
    ei->SetIntAttribute(std::string("TARGET_ACCOUNT_ID"), m_taxCounterparty.GetCurrentSuggestion()->Id);
    ...
    ei->SetIntAttribute(std::string("SOURCE_ACCOUNT_ID"), m_intermediateAccount.GetCurrentSuggestion()->Id);
    ...
    postTaxDeductions->SetIntAttribute(std::string("TARGET_ACCOUNT_ID"), m_employerAccount.GetCurrentSuggestion()->Id);
    ...
    postTaxDeductions->SetIntAttribute(std::string("SOURCE_ACCOUNT_ID"), m_intermediateAccount.GetCurrentSuggestion()->Id);
    ...
    directDeposit->SetIntAttribute(std::string("SOURCE_ACCOUNT_ID"), m_intermediateAccount.GetCurrentSuggestion()->Id);
    ...
    directDeposit->SetIntAttribute(std::string("TARGET_ACCOUNT_ID"), m_destinationAccount.GetCurrentSuggestion()->Id);
    ...
    preTaxAllocations->SetIntAttribute(std::string("TARGET_ACCOUNT_ID"), m_employerAccount.GetCurrentSuggestion()->Id);
    ...
    preTaxAllocations->SetIntAttribute(std::string("SOURCE_ACCOUNT_ID"), m_intermediateAccount.GetCurrentSuggestion()->Id);

...
void pft::TransferForm::Initialize() {
    Form::Initialize();
...
void pft::TransferForm::Copy(Form *target) {
    // UNIMPLEMENTED
}

void pft::TransferForm::PopulateTransactions(Transaction *container, Transaction *fromSource, Transaction *toDest) {
    ...
    // NOTE - PARENT_ENTITY_ID must be set later once the parent transaction is actually created
